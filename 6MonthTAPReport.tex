...
\todo{Types of colonisation?? Critical colonisation etc??}
...
RONS can be visualised inside cells using fluorescent dyes, an example of which is shown by the likes of Joshi \textit{et al} \cite{Joshi2010control} \todo{Check, is RONS increased after plasma-ing?}.
\todo{Outcome of oxidative stress?!}
