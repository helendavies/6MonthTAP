...
%As an add-on to GlobalKin, it is also possible to run a pathways analysis model on the data produced by GlobalKin.
%
%\subsection{Reaction Pathway Analysis}
%
%PumpKin is a pathways analysis tool, which can indicate the dominant reactions producing and destroying species in the plasma \cite{Markosyan2014pumpkin}.
...
%
%As an example, using the data for the spatial distribution of OH presented in my last TAP meeting, the reaction pathways analysis can be carried out at different points along the channel to see how the mechanisms of OH production and destruction change along the channel.
